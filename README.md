...
```
## OUTPUT:
<img width="1711" height="603" alt="image" src="https://github.com/user-attachments/assets/54a1d441-d3ec-42e4-b83a-cf05768f4f02" />
<img width="1711" height="645" alt="image" src="https://github.com/user-attachments/assets/13caf507-a9a3-4087-8b35-bc65716b35f4" />

<img width="1498" height="460" alt="image" src="https://github.com/user-attachments/assets/4bb684d9-df89-4440-a0a3-106351346315" />


## RESULT:
Thus the program has been executed by using CUDA to transpose a matrix. It is observed that there are variations shared memory and global memory implementation. The elapsed times are recorded as 0.003794 sec and  0.003392 sec.
